...
metadata {
    definition(name: "IKEA Fyrtur Blackout Roller Blind", namespace: "SmartThings", author: "Alvin Chen", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade") {
        capability "Actuator"
