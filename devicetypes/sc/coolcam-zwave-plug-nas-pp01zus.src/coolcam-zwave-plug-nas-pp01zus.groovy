/**
 *  CoolCam Z-Wave Plug - NAS-PP01ZUS 
 *
...
metadata {
        definition (name: "CoolCam Z-Wave Plug (NAS-PP01ZUS)", namespace: "SmartThings", author: "Alvin Chen with SoonChye") {
                capability "Switch"
                capability "Refresh"
                ...
                fingerprint deviceId: "0x1001", inClusters: "0x5E, 0x72, 0x86, 0x85, 0x59, 0x5A, 0x73, 0x70, 0x25, 0x27, 0x71, 0x32, 0x20", outClusters: ""
...
def zwaveEvent(physicalgraph.zwave.commands.basicv1.BasicReport cmd)
{
        ...
        result << createEvent(name:"level", value: cmd.value, unit:"%", descriptionText:"${device.displayName} set to ${cmd.value==255 ? 100 : cmd.value}%")
